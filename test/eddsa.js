...
describe("EdDSA Poseidon test", function () {
    ...
    it("Sign a single number", async () => {
        ...
        const msg_hex = toHexString(msg)
        console.log("msg_hex",msg_hex)

        const msg_big = BigInt("0x"+msg_hex)
        console.log("msg_big",msg_big.toString())

        console.log("msg_big - p",msg_big-p)

        console.log("toObject(msg)", F.toObject(msg))
